...
Below is a box plot of the age distributions for men and women in each education category.
...
merged_df |>
  ...
  labs(
    x = "Age",
    y = "Total MIMS activity over the day",
    title = "Comparison of the total activity over the day for men and women of each education level"
  )
```

Below is a three-panel plot that shows the 24-hour activity time courses for each education level.
...
merged_df |>
  ...
  labs(
    ...
    y = "MIMS value",
    color = "Sex",
    title = "24-hour MIMS activity for each education level"
  )
```